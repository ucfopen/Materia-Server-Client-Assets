 ...
 */
Namespace('Materia').Score = (function() {
	...
	const _error = (fn, types) => Materia.Engine.alert('Scoring Error', 'An error has occurred with the scoring of this widget. Please refresh and try again. If the problem persists, notify your instructor or contact an instructional designer.');
