require('./controllers/ctrl-collaboration')
require('./controllers/ctrl-create')
require('./controllers/ctrl-export-scores')
require('./controllers/ctrl-lti')
require('./controllers/ctrl-media-import')
require('./controllers/ctrl-my-widgets')
require('./controllers/ctrl-question-import')
require('./controllers/ctrl-selectedwidget')
require('./controllers/ctrl-widget-settings')
